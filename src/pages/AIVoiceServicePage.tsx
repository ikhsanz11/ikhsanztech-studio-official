...
const workflowSteps = [
    {
        id: 1,
        title: 'Kirim Sampel & Naskah',
        description: 'Kirimkan contoh suara Anda dan naskah yang sudah ditulis.',
        icon: FileAudio
    },
    {
        id: 2,
        title: 'Kloning Suara Premium',
        description: 'Pembuatan kloning suara menggunakan software premium sesuai ekspektasi.',
        icon: Mic2
    },
    {
        id: 3,
        title: 'Text-to-Speech Eleven Labs',
        description: 'Mengubah naskah menjadi suara menggunakan teknologi Eleven Labs.',
        icon: Volume2
    },
    {
        id: 4,
        title: 'Hasil Profesional',
        description: 'Pengiriman file audio berkualitas tinggi yang siap digunakan.',
        icon: Headphones
    },
];

const features = [
    '1 Voice Eksklusif (Durasi hingga 5 menit)',
    'Custom Suara (Cloning)',
    'High-Quality (HQ) Audio File',
    'Bisa Ubah ke Berbagai Bahasa',
];

export function AIVoiceServicePage() {
    return (
            ...
            <div className="relative z-10">
                ...
                <section className="pt-32 sm:pt-28 pb-16 px-4 sm:px-6">
                    <div className="max-w-5xl mx-auto">
                            ...
                            <div className="flex flex-col lg:flex-row gap-8 items-center">
                                ...
                                <div className="w-full lg:w-1/2">
                                    <div className="rounded-2xl overflow-hidden border border-white/10">
                                        <img
                                            src="https://public.youware.com/image/3f9a7885-8c1a-45d8-a3c4-1e5ddcc86fb7/9fwt1vueaz.png"
                                            alt="Jasa Voice Over AI | Cloning Voice"
                                ...
                                <div className="w-full lg:w-1/2 text-center lg:text-left">
                                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2">
                                        Jasa Voice Over AI | Cloning Voice
                                    </h1>
                                    <p className="text-white/60 text-lg mb-6">Premium Service</p>
                        ...
                        >
                            <p className="text-white/50 text-xs sm:text-sm max-w-2xl mx-auto italic">
                                Jika Anda lebih memilih menggunakan suara sendiri tanpa cloning, kami juga bisa membantu mengubah suara tersebut ke berbagai bahasa.
                            </p>
                        </motion.div>
                        ...
                        >
                            ...
                            <motion.button
                                onClick={() => handleWhatsAppClick('https://wa.me/6287877066270?text=Halo%20Ikhsanztech-studio%2C%20saya%20tertarik%20dengan%20Jasa%20Cloning%20Voice%20AI%20Premium.%20Saya%20ingin%20mengubah%20naskah%20saya%20menjadi%20suara%20yang%20profesional.')}
