...
const features = [
    'Konsistensi karakter AI sekali klik',
    'Upload 1 foto, hasilkan ratusan pose',
    'Gaya sinematik profesional',
    'Cocok untuk branding & storytelling',
                        ...
                        <div className="flex flex-col lg:flex-row gap-8 items-center">
                            <div className="w-full lg:w-1/2">
                                <div className="bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-4">
                                    <img
                                        src="/nano-image-gen.jpg"
                                        alt="Nano Banana Image Prompt Gen"
                            ...
                            <div className="w-full lg:w-1/2 bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-6 lg:p-8">
                                ...
                                <p className="text-white/70 text-sm sm:text-base mb-6 leading-relaxed">
                                    Bangun konsistensi karakter sekali klik. Cukup upload 1 foto untuk hasilkan ratusan pose sinematik.
                                </p>

                                <div className="flex items-baseline gap-3 mb-6">
                                    <span className="text-3xl font-bold text-white">IDR 139.000</span>
                                    <span className="text-zinc-500 line-through">IDR 499.000</span>
                                </div>
                                ...
                                <motion.a
                                    href="https://wa.me/6287877066270?text=Halo%20Ikhsanztech-studio,%20saya%20ingin%20membeli%20Nano%20Banana%20Image%20Gen."
                                    target="_blank"
