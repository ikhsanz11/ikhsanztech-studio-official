...
const features = [
    'Workflow rahasia asli Ikhsanztech Studio',
    'Dari 1 gambar jadi film sinematik utuh',
    'Konsistensi karakter tingkat tinggi',
    'Teknik editing profesional',
    'Akses selamanya',
    'Update gratis seumur hidup',
];

export function NanoWorkflowPage() {
    return (
                        ...
                        <div className="flex flex-col lg:flex-row gap-8 items-center">
                            <div className="w-full lg:w-1/2">
                                <div className="bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-4">
                                    <img
                                        src="/nano-workflow.jpg"
                                        alt="Nano Banana Workflow"
                            ...
                            <div className="w-full lg:w-1/2 bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-6 lg:p-8">
                                ...
                                <p className="text-white/50 text-sm mb-2">Consistent Character</p>

                                <p className="text-white/70 text-sm sm:text-base mb-6 leading-relaxed">
                                    Bongkar rahasia workflow asli dari Ikhsanztech Studio. Dari satu gambar jadi film sinematik utuh.
                                </p>

                                <div className="flex items-baseline gap-3 mb-6">
                                    <span className="text-3xl font-bold text-white">IDR 269.000</span>
                                    <span className="text-zinc-500 line-through">IDR 750.000</span>
                                </div>
                                ...
                                <motion.a
                                    href="https://wa.me/6287877066270?text=Halo%20Ikhsanztech-studio,%20saya%20ingin%20membeli%20Nano%20Banana%20Workflow."
                                    target="_blank"
