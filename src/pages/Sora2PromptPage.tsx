...
const features = [
    'Ubah gambar statis menjadi video hidup',
    'Detail sinematik berkualitas tinggi',
    'Kendali kamera penuh (zoom, pan, tilt)',
    'Kompatibel dengan Sora 2',
    'Output berkualitas profesional',
    'Panduan penggunaan lengkap',
];

export function Sora2PromptPage() {
    return (
                        ...
                        <div className="flex flex-col lg:flex-row gap-8 items-center">
                            <div className="w-full lg:w-1/2">
                                <div className="bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-4">
                                    <img
                                        src="/sora2-prompt.jpg"
                                        alt="Sora2 Smart Prompt Gen"
                            ...
                            <div className="w-full lg:w-1/2 bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-6 lg:p-8">
                                ...
                                <p className="text-white/70 text-sm sm:text-base mb-6 leading-relaxed">
                                    Ubah gambar statis menjadi video hidup dengan detail sinematik dan kendali kamera penuh.
                                </p>
                                ...
                                <motion.a
                                    href="https://wa.me/6287877066270?text=Halo%20Ikhsanztech-studio,%20saya%20ingin%20membeli%20Sora2%20Smart%20Prompt."
                                    target="_blank"
