...
const workflowSteps = [
    { id: 1, title: 'Konsultasi Konsep & Keinginan (Bisa langsung konsul!)', icon: MessageCircle },
    { id: 2, title: 'Kirim file/footage (GoogleDrive/Dropbox)', icon: Upload },
    { id: 3, title: 'Pengerjaan project video', icon: Clapperboard },
    { id: 4, title: 'Mengirimkan hasil video yang diedit', icon: Send },
    { id: 5, title: 'Peninjauan dan Revisi', icon: ClipboardCheck },
    { id: 6, title: 'Selesai :)', icon: CheckCircle2 },
];

const features = [
    '1 Video, Maks. 30 Detik (Cut to cut dinamis)',
    'Konten Sesuai Tren & Kebutuhan',
    'Editing Profesional (Caption, transisi, efek Premiere & AE)',
    '1x Revisi GRATIS',
    'Hak Milik Penuh (100% milik Anda/brand)',
];
                ...
                <section className="pt-32 sm:pt-28 pb-16 px-4 sm:px-6">
                    <div className="max-w-5xl mx-auto">
                            ...
                            <div className="flex flex-col lg:flex-row gap-8 items-center">
                                ...
                                <div className="w-full lg:w-1/2">
                                    <div className="rounded-2xl overflow-hidden border border-white/10">
                                        <img
                                            src="https://public.youware.com/image/b737ca1f-7843-4aef-a844-6c8dfd94be17/1tyukzjspa.png"
                                            alt="Jasa Edit Video Konten ADS Game / 3D Animation"
                                ...
                                <div className="w-full lg:w-1/2 text-center lg:text-left">
                                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-6">
                                        Jasa Edit Video Konten ADS Game / 3D Animation
                                    </h1>
                        ...
                        >
                            ...
                            <motion.button
                                onClick={() => handleWhatsAppClick('https://wa.me/6287877066270?text=Halo%20Ikhsanztech-studio%2C%20saya%20ingin%20konsultasi%20buat%20Video%20ADS%20Game%20atau%203D%20Animation.')}
