...
const features = [
    'Sekali beli untuk selamanya',
    'Sistem kendali kamera profesional',
    'Kontrol emosi dan mood',
    'Template berbagai genre video',
                        ...
                        <div className="flex flex-col lg:flex-row gap-8 items-center">
                            <div className="w-full lg:w-1/2">
                                <div className="bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-4">
                                    <img
                                        src="/video-gen-baru.jpg"
                                        alt="Video Prompt Generator"
                            ...
                            <div className="w-full lg:w-1/2 bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-6 lg:p-8">
                                ...
                                <p className="text-white/70 text-sm sm:text-base mb-6 leading-relaxed">
                                    Ubah gambar statis menjadi video AI sinematik sekelas arahan film profesional. Dilengkapi sistem kendali kamera dan emosi untuk hasil yang memukau.
                                </p>

                                <div className="flex items-baseline gap-3 mb-6">
                                    <span className="text-3xl font-bold text-white">IDR 169.000</span>
                                    <span className="text-zinc-500 line-through">IDR 799.000</span>
                                </div>
                                ...
                                <motion.a
                                    href="https://wa.me/6287877066270?text=Halo,%20saya%20ingin%20membeli%20Video%20Prompt%20Gen."
                                    target="_blank"
