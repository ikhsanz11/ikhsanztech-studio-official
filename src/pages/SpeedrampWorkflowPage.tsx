...
const features = [
    'Mindset AI Video Director lengkap',
    'Tutorial Nano Banana Pro step-by-step',
    'Efek cinematic profesional',
    'Teknik speedramp seperti film Hollywood',
    'File project siap pakai',
    'Update gratis seumur hidup',
];

export function SpeedrampWorkflowPage() {
    return (
                        ...
                        <div className="flex flex-col lg:flex-row gap-8 items-center">
                            <div className="w-full lg:w-1/2">
                                <div className="bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-4">
                                    <img
                                        src="/speedramp-workflow.jpg"
                                        alt="Speedramp Effect Workflow"
                            ...
                            <div className="w-full lg:w-1/2 bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-6 lg:p-8">
                                <h1 className="font-sora text-2xl sm:text-3xl font-bold text-white mb-4">
                                    Speedramp Effect Workflow
                                </h1>

                                <p className="text-white/70 text-sm sm:text-base mb-6 leading-relaxed">
                                    Mindset AI Video Director dengan tutorial Nano Banana Pro. Efek cinematic profesional untuk video Anda.
                                </p>

                                <div className="flex items-baseline gap-3 mb-6">
                                    <span className="text-3xl font-bold text-white">IDR 199.000</span>
                                    <span className="text-zinc-500 line-through">IDR 899.000</span>
                                </div>
                                ...
                                <motion.a
                                    href="https://wa.me/6287877066270?text=Halo%20Ikhsanztech-studio,%20saya%20ingin%20membeli%20Speedramp%20Effect%20Workflow.%20Mohon%20info%20pembayarannya."
                                    target="_blank"
