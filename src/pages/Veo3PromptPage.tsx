...
const features = [
    'Generator prompt khusus Veo 3.1',
    'Atmosfer film profesional kelas dunia',
    'Kualitas output sinematik',
    'Kontrol detail pencahayaan',
    'Optimasi untuk berbagai genre',
    'Dokumentasi lengkap',
];

export function Veo3PromptPage() {
    return (
                        ...
                        <div className="flex flex-col lg:flex-row gap-8 items-center">
                            <div className="w-full lg:w-1/2">
                                <div className="bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-4">
                                    <img
                                        src="/veo31-prompt.jpg"
                                        alt="Veo 3.1 Smart Prompt Gen"
                            ...
                            <div className="w-full lg:w-1/2 bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-6 lg:p-8">
                                <h1 className="font-sora text-2xl sm:text-3xl font-bold text-white mb-4">
                                    Veo 3.1 Smart Prompt
                                </h1>

                                <p className="text-white/70 text-sm sm:text-base mb-6 leading-relaxed">
                                    Generator prompt khusus untuk model Veo 3.1, menghasilkan atmosfer film profesional kelas dunia.
                                </p>

                                <div className="flex items-baseline gap-3 mb-6">
                                    <span className="text-3xl font-bold text-white">IDR 139.000</span>
                                    <span className="text-zinc-500 line-through">IDR 465.000</span>
                                </div>
                                ...
                                <motion.a
                                    href="https://wa.me/6287877066270?text=Halo%20Ikhsanztech-studio,%20saya%20ingin%20membeli%20Veo%203.1%20Smart%20Prompt."
                                    target="_blank"
