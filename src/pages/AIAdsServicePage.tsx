...
const features = [
    ...
    'Free Voice Over',
    'Konten Berkualitas & Editing Profesional',
    'Hak Milik Penuh',
    'Permintaan lain bisa langsung chat',
];

const sliderImages = [
    { src: '/jasa-ai-ads.png', alt: 'Jasa Produksi Konten AI - Thumbnail' },
    { src: '/showcase/ai-ads/Artboard 11.png', alt: 'AI Ads Showcase 1' },
    { src: '/showcase/ai-ads/Artboard 12.png', alt: 'AI Ads Showcase 2' },
    { src: '/showcase/ai-ads/Artboard 13.png', alt: 'AI Ads Showcase 3' },
    { src: '/showcase/ai-ads/Artboard 14.png', alt: 'AI Ads Showcase 4' },
    { src: '/showcase/ai-ads/Artboard 15.png', alt: 'AI Ads Showcase 5' },
    { src: '/showcase/ai-ads/Artboard 16.png', alt: 'AI Ads Showcase 6' },
    { src: '/showcase/ai-ads/Artboard 17.png', alt: 'AI Ads Showcase 7' },
    { src: '/showcase/ai-ads/Artboard 18.png', alt: 'AI Ads Showcase 8' },
];

export function AIAdsServicePage() {
                ...
                <section className="pt-32 sm:pt-28 pb-16 px-4 sm:px-6">
                    <div className="max-w-5xl mx-auto">
                            ...
                            <div className="flex flex-col lg:flex-row gap-8 items-center">
                                ...
                                <div className="w-full lg:w-1/2 text-center lg:text-left">
                                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2">
                                        Jasa Produksi Konten AI | Promosi & Iklan
                                    </h1>
                        ...
                        >
                            ...
                            <motion.button
                                onClick={() => handleWhatsAppClick('https://wa.me/6287877066270?text=Halo%20Ikhsanztech-studio%2C%20saya%20butuh%20Jasa%20Produksi%20Konten%20AI%20untuk%20Promosi%20%26%20Iklan.%20Bisa%20bantu%20jelaskan%20prosedurnya%3F')}
