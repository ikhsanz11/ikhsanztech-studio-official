...
const features = [
    '1200 Kredit Premium',
    'Akun Pribadi Eksklusif',
    'Support SORA 2',
    'Support VEO 3',
    'Support WAN 2.5',
    'Teknologi pergerakan AI terhalus',
];

export function HiggsfieldAiPage() {
    return (
                        ...
                        <div className="flex flex-col lg:flex-row gap-8 items-center">
                            <div className="w-full lg:w-1/2">
                                <div className="bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-4">
                                    <img
                                        src="/higgsfield-baru.jpg"
                                        alt="HIGGSFIELD AI 1200C"
                            ...
                            <div className="w-full lg:w-1/2 bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-6 lg:p-8">
                                ...
                                <p className="text-white/70 text-sm sm:text-base mb-6 leading-relaxed">
                                    Teknologi pergerakan video AI paling halus saat ini untuk kreator profesional. Ciptakan konten revolusioner dalam hitungan detik.
                                </p>

                                <div className="flex items-baseline gap-3 mb-6">
                                    <span className="text-3xl font-bold text-white">IDR 499.000</span>
                                    <span className="text-zinc-500 line-through">IDR 855.000</span>
                                </div>
                                ...
                                <motion.a
                                    href="https://wa.me/6287877066270?text=Halo,%20saya%20ingin%20membeli%20paket%20HIGGSFIELD%20AI%201200C."
                                    target="_blank"
