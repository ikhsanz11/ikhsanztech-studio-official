...
const features = [
    ...
    'Support Midjourney Premium',
    'Support Adobe Creative Cloud',
    'Support berbagai platform AI lainnya',
                        ...
                        <div className="flex flex-col lg:flex-row gap-8 items-center">
                            ...
                            <div className="w-full lg:w-1/2 bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-6 lg:p-8">
                                ...
                                <p className="text-white/70 text-sm sm:text-base mb-4 leading-relaxed">
                                    Solusi resmi untuk aktivasi trial platform global (Midjourney, Adobe, dll.) dengan garansi 100% berhasil.
                                </p>
                                ...
                                <div className="bg-green-900/30 border border-green-500/30 rounded-xl p-4 mb-6">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <p className="text-green-300 text-sm font-medium">
                                            Garansi 100% Berhasil atau Uang Kembali
                                        </p>
                                    </div>
                                </div>

                                <div className="flex items-baseline gap-3 mb-6">
                                    <span className="text-3xl font-bold text-white">IDR 249.000</span>
                                    <span className="text-zinc-500 line-through">IDR 400.000</span>
                                </div>
                                ...
                                <motion.a
                                    href="https://wa.me/6287877066270?text=Halo%20Ikhsanztech-studio,%20saya%20ingin%20membeli%20Credit%20Card%20Pembayaran.%20Mohon%20info%20pembayarannya."
                                    target="_blank"
