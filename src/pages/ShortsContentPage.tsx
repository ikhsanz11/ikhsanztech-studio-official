...
const workflowSteps = [
    { id: 1, title: 'Diskusi konsep dengan client', icon: MessageCircle },
    { id: 2, title: 'Menyepakati konsep dan brief', icon: FileCheck },
    { id: 3, title: 'Freelancer menyelesaikan pekerjaan', icon: Clapperboard },
    { id: 4, title: 'Freelancer mengirim draft video ke klien', icon: Send },
    { id: 5, title: 'Pengiriman video final resolusi tinggi (jika setuju)', icon: Film },
    { id: 6, title: 'Revisi sampai acc (jika belum puas)', icon: RefreshCw },
];

const features = [
    '1 Video Eksklusif (Durasi hingga 1 menit)',
    'Konten Berkualitas (Sesuai tren & permintaan)',
    'Editing Profesional (Caption, transisi, efek menarik)',
    'Revisi Tanpa Batas (Hingga sesuai keinginan)',
    'Hak Milik Penuh (100% milik Anda)',
];

const sliderImages = [
    { src: '/jasa-reels-tiktok.png', alt: 'Membuat Konten Reels, TikTok, Short & Ads - Thumbnail' },
    { src: '/showcase/shorts-content/Artboard 37.png', alt: 'Shorts Content Showcase 1' },
    { src: '/showcase/shorts-content/Artboard 38.png', alt: 'Shorts Content Showcase 2' },
    { src: '/showcase/shorts-content/Artboard 39.png', alt: 'Shorts Content Showcase 3' },
    { src: '/showcase/shorts-content/Artboard 40.png', alt: 'Shorts Content Showcase 4' },
    { src: '/showcase/shorts-content/Artboard 41.png', alt: 'Shorts Content Showcase 5' },
    { src: '/showcase/shorts-content/Artboard 42.png', alt: 'Shorts Content Showcase 6' },
    { src: '/showcase/shorts-content/Artboard 43.png', alt: 'Shorts Content Showcase 7' },
    { src: '/showcase/shorts-content/Artboard 44.png', alt: 'Shorts Content Showcase 8' },
];

export function ShortsContentPage() {
                ...
                <section className="pt-32 sm:pt-28 pb-16 px-4 sm:px-6">
                    <div className="max-w-5xl mx-auto">
                            ...
                            <div className="flex flex-col lg:flex-row gap-8 items-center">
                                ...
                                <div className="w-full lg:w-1/2 text-center lg:text-left">
                                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-2">
                                        Membuat Konten Reels, TikTok, Short & Ads
                                    </h1>
                                    <p className="text-white/60 text-lg mb-6">Profesional & Berkualitas</p>
                        ...
                        >
                            ...
                            <motion.button
                                onClick={() => handleWhatsAppClick('https://wa.me/6287877066270?text=Halo%20Ikhsanztech-studio%2C%20saya%20ingin%20membuat%20konten%20Reels%2FTikTok%2FShorts%20yang%20profesional.%20Bisa%20kita%20mulai%20diskusinya%3F')}
