...
const features = [
    ...
    'Akurasi historis otentik',
    'Reverse Prompt (Image-to-Text)',
    'Multi-style support',
                        ...
                        <div className="flex flex-col lg:flex-row gap-8 items-center">
                            ...
                            <div className="w-full lg:w-1/2 bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-6 lg:p-8">
                                ...
                                <p className="text-white/70 text-sm sm:text-base mb-6 leading-relaxed">
                                    Bangun adegan AI sinematik dan ultra-realistis. Kualitas visual setara film dengan akurasi historis otentik. Mendukung Reverse Prompt.
                                </p>

                                <div className="flex items-baseline gap-3 mb-6">
                                    <span className="text-3xl font-bold text-white">IDR 149.000</span>
                                    <span className="text-zinc-500 line-through">IDR 599.000</span>
                                </div>
                                ...
                                <motion.a
                                    href="https://wa.me/6287877066270?text=Halo,%20saya%20ingin%20membeli%20Image%20Prompt%20Gen."
                                    target="_blank"
