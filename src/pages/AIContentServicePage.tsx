...
const sliderImages = [
    { src: '/jasa-ai-content.png', alt: 'Jasa Pembuatan Konten AI Kreatif - Thumbnail' },
    { src: '/ai-content-showcase-1.png', alt: 'AI Content Showcase 1' },
    { src: '/ai-content-showcase-2.png', alt: 'AI Content Showcase 2' },
    { src: '/ai-content-showcase-3.png', alt: 'AI Content Showcase 3' },
    { src: '/ai-content-showcase-5.png', alt: 'AI Content Showcase 5' },
    { src: '/ai-content-showcase-6.png', alt: 'AI Content Showcase 6' },
    { src: '/ai-content-showcase-7.png', alt: 'AI Content Showcase 7' },
    { src: '/ai-content-showcase-8.png', alt: 'AI Content Showcase 8' },
    { src: '/ai-content-showcase-4.png', alt: 'AI Content Showcase 4' },
];
                ...
                <section className="pt-32 sm:pt-28 pb-16 px-4 sm:px-6">
                    <div className="max-w-5xl mx-auto">
                        ...
                        >
                            ...
                            <motion.button
                                onClick={() => handleWhatsAppClick('https://wa.me/6287877066270?text=Halo%20Ikhsanztech-studio%2C%20saya%20tertarik%20dengan%20Jasa%20Pembuatan%20Konten%20AI.%20Mari%20kita%20diskusikan%20kebutuhan%20bisnis%20saya!')}
