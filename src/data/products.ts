...
export const products: Product[] = [
    {
        id: 'flow-ai',
        name: 'FLOW AI 25000 KREDIT',
        description: 'Akses teknologi canggih Google dengan 25.000 Kredit Premium',
        price: 769000,
        displayPrice: 'IDR 769.000',
        originalPrice: 'IDR 3.849.000',
        image: '/flow-baru.png',
        category: 'account',
        features: [
            '25.000 Kredit Premium',
    ...
    {
        id: 'google-ai-ultra',
        name: 'Google AI Ultra Privat | 25000 KREDIT',
    ...
    {
        id: 'kelas-ai',
        name: 'Belajar AI - Ikhsanztech studio',
        description: 'Pengen ngerti gimana cara kerja AI tools terbaru, dapetin prompt rahasia, dan tau strategi bikin konten viral pakai AI kayak kreator profesional? Inilah tempat kamu belajar langsung bareng Ikhsanz Tech.',
        price: 599000,
        ...
        features: [
            ...
            'Diskusi privat langsung bareng Ikhsanz Tech — strategi AI, konten, monetisasi',
            'Lifetime akses + update rutin setiap ada tren & tools AI terbaru',
        ],
    },
    {
        id: 'nano-banana',
