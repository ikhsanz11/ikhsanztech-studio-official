              ...
              >
                ...
                <div className="w-full lg:w-1/2 flex flex-col gap-5 bg-zinc-900/40 backdrop-blur-md border border-white/10 rounded-2xl p-6 lg:p-8">
                  ...
                  {currentService.link ? (
                    ...
                    <motion.button
                      onClick={() => handleWhatsAppClick('https://wa.me/6287877066270')}
